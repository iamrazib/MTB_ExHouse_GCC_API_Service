...
namespace GCCService.Global
{
    public class Utility
    {
        ...
        public static string OccupationName(int code)
        {
            string occuName = "";
            switch (code)
            {
                case 1: occuName = "Skilled Worker";
                    break;
                case 2: occuName = "Business";
                    break;
                case 3: occuName = "Government Official";
                    break;
                default: occuName = "Others";
                    break;
            }
            return occuName;
        }
